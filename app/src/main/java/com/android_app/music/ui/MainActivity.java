...
import com.android_app.music.databinding.ActivityMainBinding;
import com.android_app.music.fragment.AllSongsFragment;
import com.android_app.music.fragment.ContactFragment;
import com.android_app.music.fragment.FeaturedSongsFragment;
import com.android_app.music.fragment.FeedbackFragment;
import com.android_app.music.fragment.HomeFragment;
import com.android_app.music.fragment.NewSongsFragment;
import com.android_app.music.fragment.PopularSongsFragment;
import com.android_app.music.model.Song;
import com.android_app.music.service.MusicService;
import com.android_app.music.utils.GlideUtils;
...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (viewId == R.id.layout_close) {
            ...
            displayLayoutPlayAll();
        } else if (viewId == R.id.tv_menu_popular_songs) {
            mActivityMainBinding.drawerLayout.closeDrawer(GravityCompat.START);
            openPopularSongsScreen();
        } else if (viewId == R.id.tv_menu_new_songs) {
            mActivityMainBinding.drawerLayout.closeDrawer(GravityCompat.START);
            openNewSongsScreen();
        } else if (viewId == R.id.tv_menu_feedback) {
            mActivityMainBinding.drawerLayout.closeDrawer(GravityCompat.START);
            replaceFragment(new FeedbackFragment());
            mTypeScreen = TYPE_FEEDBACK;
            initToolbar(getString(R.string.menu_feedback));
            displayLayoutPlayAll();
        } else if (viewId == R.id.tv_menu_contact) {
            mActivityMainBinding.drawerLayout.closeDrawer(GravityCompat.START);
            replaceFragment(new ContactFragment());
            mTypeScreen = TYPE_CONTACT;
            initToolbar(getString(R.string.menu_contact));
            displayLayoutPlayAll();
        } else if (viewId == R.id.img_previous) {
            clickOnPrevButton();
        } else if (viewId == R.id.img_play) {
            clickOnPlayButton();
        } else if (viewId == R.id.img_next) {
            clickOnNextButton();
        } else if (viewId == R.id.img_close) {
            clickOnCloseButton();
        } else if (viewId == R.id.layout_text || viewId == R.id.img_song) {
