...
import com.android_app.music.adapter.BannerSongAdapter;
import com.android_app.music.adapter.SongAdapter;
import com.android_app.music.adapter.SongGridAdapter;
import com.android_app.music.constant.Constant;
import com.android_app.music.constant.GlobalFunction;
import com.android_app.music.databinding.FragmentHomeBinding;
...
public class HomeFragment extends Fragment {
    ...
    private void getListSongFromFirebase(String key) {
        ...
        ControllerApplication.get(getActivity()).getSongsDatabaseReference().addValueEventListener(new ValueEventListener() {
            @Override
